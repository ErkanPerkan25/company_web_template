...
function Navbar(){
    ...
    return(
        <div className="realtive sticky h-20 flex flex-row items-center bg-stone-500">
            <h1 className="ml-50 text-3xl font-bold text-center"><Link to="/">Company Name</Link></h1>
